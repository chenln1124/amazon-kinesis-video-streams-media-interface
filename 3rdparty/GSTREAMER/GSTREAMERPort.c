...
#define INCLUDE_FILE(name, head) STRINGIFY(CONCATENATE(name, head))
...
static int startGstAppSinkSrc(GSTAppModuleType type)
{
    GstElement *pipeline = NULL;
    switch (type) {
        case VIDEO_CAPTURE_APP_SINK:
...
static int stopGstAppSinkSrc(GSTAppModuleType type)
{
    GstElement *pipeline = NULL;
    switch (type) {
        case VIDEO_CAPTURE_APP_SINK:
...
static int deinitGstAppSinkSrc(GSTAppModuleType type)
{
    GstElement *pipeline = NULL;
    switch (type) {
        case VIDEO_CAPTURE_APP_SINK:
